  ...
  <v-container>
    ...
    <v-card class="staff-toolbar-card mb-4" elevation="0">
      <v-card-text class="toolbar">
        ...
        <v-select v-model="status" :items="statusOptions" item-title="label" item-value="value" label="Status" variant="outlined" density="compact" hide-details class="toolbar-field" />
        <v-text-field v-model="search" label="Buscar cliente/colaborador" variant="outlined" density="compact" hide-details class="toolbar-field" />
