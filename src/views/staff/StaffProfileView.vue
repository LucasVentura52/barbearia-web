          ...
          <v-card class="glass-card" elevation="0">
            <v-card-text class="profile-actions">
              ...
              <div class="profile-buttons">
                <v-btn color="secondary" size="large" :block="smAndDown" :loading="uploading" @click="uploadPhoto">
                  Salvar foto
                </v-btn>
                <v-btn color="secondary" variant="outlined" size="large" :block="smAndDown" @click="refresh">
                  Atualizar dados
                </v-btn>
                <v-btn variant="outlined" color="secondary" size="large" :block="smAndDown" @click="logout">
                  Sair
                </v-btn>
              </div>
            </v-card-text>
          ...
          <v-card class="glass-card" elevation="0">
            <v-card-text class="profile-actions">
              ...
              <v-text-field v-model="passwordForm.confirmation" label="Repetir nova senha" type="password"
                variant="outlined" />
              <div class="profile-buttons">
                <v-btn color="secondary" size="large" :block="smAndDown" :loading="updatingPassword" @click="updatePassword">
                  Atualizar senha
                </v-btn>
              </div>
            </v-card-text>
